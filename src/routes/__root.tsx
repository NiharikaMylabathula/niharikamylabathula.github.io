...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A curated portfolio of projects, skills, and writing." },
      { name: "author", content: "Portfolio" },
      { property: "og:title", content: "Portfolio — Creative Developer & Designer" },
      { property: "og:description", content: "A curated portfolio of projects, skills, and writing." },
